...
const a1 = annotate(e1, { type: 'underline', color: '#FF218CCC', strokeWidth: '1.5' })
const a2 = annotate(e2, { type: 'underline', color: '#FFD800CC', strokeWidth: '1.5' })
const a3 = annotate(e3, { type: 'underline', color: '#21B1FFCC', strokeWidth: '1.5' })
const a4 = annotate(e4, { type: 'underline', color: '#38ef7dCC', strokeWidth: '1.5' })
